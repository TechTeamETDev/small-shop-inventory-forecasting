    ...
    <table class="table-auto w-full border">
        ...
        <tbody id="categoryTable">
            ...
            <tr id="categoryRow<?php echo e($category->id); ?>">
                <td class="border px-3 py-2"><?php echo e($category->id); ?></td>
                <td class="border px-3 py-2"><?php echo e($category->name); ?></td>
                <td class="border px-3 py-2 flex gap-2">
                    <button class="text-yellow-600 editCategory" data-id="<?php echo e($category->id); ?>">✏ Edit</button>
                    <button class="text-red-600 deleteCategory" data-id="<?php echo e($category->id); ?>">🗑 Delete</button>
                </td>
            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\N Computer\Desktop\small-shop-inventory-forecasting\resources\views/categories/index.blade.php ENDPATH**/ ?>